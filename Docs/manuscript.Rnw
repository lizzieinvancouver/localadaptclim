...
\title{{\huge Weak evidence of provenance effects in spring phenology across Europe and North America}
...
%EMWSep30: I believe you never need 'note that' -- cutting it is almost ALWAYS a good way to simplify. 
%Leaf senescence was visually inspected based on the percentage of the tree crown that had changed color when the assessor stood on the south-facing side of each tree. %EMWSep30: Good info, just too much detail; I edited. 
...
%EMWSep30 -- check umlaut on Korner works
...
\begin{figure}[!h] 
 ...
 \includegraphics[width=\textwidth]{..//..//localadaptclim/Docs/figure_ms/map_gardens.jpg}
    \caption{Distribution of common gardens (denoted as stars) and provenances (denoted as circles) included in this meta-analysis. The distribution was skewed toward North America (12 North American studies versus 5 European studies). See Table.\ref{supplement-table:all_studies} in Supplement for information on selected studies. } %EMWSep30: These lines don't actually delineate study regions ... so I suggest you delete the whole sentence unless the journal requires it or you really want it; if you keep it in, it should be: Note: map lines do not necessarily depict accepted national boundaries.
