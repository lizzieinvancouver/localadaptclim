...
\noindent Running head: Clines in spring phenology
...
\noindent \emph{Keywords: budburst, leafout, budset, senescence, climate change, common gardens, deciduous and evergreen trees, provenance, spring phenology}\\ %EWMFeb5 -- if you have an abundance of keywords, remove ones that are redundant with title/abstract
