...
\item While coarse metrics such as latitude and MAT appear to represent how similar the climates are between the provenances and gardens in months closer to the events, at least in the narrow range of northern temperature and boreal forests we studied
\end{enumerate}
\end{enumerate}
